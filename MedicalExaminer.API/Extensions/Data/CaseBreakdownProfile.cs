        ...
        public CaseBreakdownProfile()
        {
            CreateMap<CaseBreakDown, QapDiscussionPrepopulated>()
                .ForMember(prepopulated => prepopulated.CauseOfDeath1a,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.CauseOfDeath1a ?? ""))
                .ForMember(prepopulated => prepopulated.CauseOfDeath1b,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.CauseOfDeath1b ?? ""))
                .ForMember(prepopulated => prepopulated.CauseOfDeath1c,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.CauseOfDeath1c ?? ""))
                .ForMember(prepopulated => prepopulated.CauseOfDeath2,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.CauseOfDeath2 ?? ""))
                .ForMember(prepopulated => prepopulated.MedicalExaminer,
                    cbd => cbd.MapFrom(source => source.QapDiscussion.Latest.ParticipantName))
                .ForMember(prepopulated => prepopulated.DateOfLatestPreScrutiny,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.Created))
                .ForMember(prepopulated => prepopulated.PreScrutinyStatus,
                    cbd => cbd.MapFrom(source =>
                        source.PreScrutiny == null
                ...
                .ForMember(prepopulated => prepopulated.UserForLatestPrescrutiny,
                    cbd => cbd.MapFrom(source => source.PreScrutiny.Latest.UserFullName));
            CreateMap<CaseBreakDown, CaseBreakDownItem>()
                ...
                {
                    var container = EventContainerMapping<BereavedDiscussionEvent, BereavedDiscussionPrepopulated>(source.BereavedDiscussion, context);
