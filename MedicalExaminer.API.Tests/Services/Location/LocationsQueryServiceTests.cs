...
namespace MedicalExaminer.API.Tests.Services.Location
{
        ...
        LocationsQueryService>
    {
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(null, null, false, forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery("Name2", null, false, forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(null, "Name1", false, forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery("Name2", "Name1", false, forLookup);
